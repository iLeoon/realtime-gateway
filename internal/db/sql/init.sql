...
'Stores all members of every conversation, including the conversation creator.
Used for both private chats and group chats.
The creator is inserted here at conversation creation time alongside other members.';
