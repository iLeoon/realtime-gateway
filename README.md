...
[`PROTOCOL.md`](./pkg/protcol/PROTOCOL.md).
...
- WebSocket gateway for clients  
- TCP transport layer for internal engine communication  
- Binary framing system  
- Connect / Disconnect / SendMessage packet handling  
- Message routing via TCP engine  
- Clean separation between concerns  
- Session abstraction for both directions  
- Rich protocol documentation  
